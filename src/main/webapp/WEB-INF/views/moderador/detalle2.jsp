  ...
  <div class="card-body">
      ...
      <h5> Descripción: </h5>
         ...
         <div >
                  ...
                  <a class="btn btn-danger btn-lg float-right " href="misEventos1" role="button">Eliminar</a>

                  <a class="btn btn-warning btn-lg  " href="editar21" role="button">Editar</a>

                                                                   
                  <a class="btn btn-primary btn-lg float-left " href="misEventos1" role="button">Regresar</a>
