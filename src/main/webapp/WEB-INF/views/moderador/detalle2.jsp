                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div >
                                                ...
                                                <a class="btn btn-danger btn-lg float-right " href="${rootUrl}moderador/eliminarEvento1/${evento.id}" role="button">Eliminar</a>
                                                <a class="btn btn-warning btn-lg  " href="editar2" role="button">Editar</a>   
                                                <a class="btn btn-primary btn-lg float-left " href="${rootUrl}moderador/misEventos/${sessionScope.usuario.id}" role="button">Regresar</a>
