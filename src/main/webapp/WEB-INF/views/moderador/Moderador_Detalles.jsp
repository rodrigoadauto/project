  ...
  <div class="card-body">
      ...
      <h5> Descripción: </h5>
         ...
         <div >
                                  ...
                                  <a class="btn btn-primary btn-lg float-right " href="eventosAsistidos1" role="button">Asistir</a>                                 
                  <a class="btn btn-primary btn-lg float-left " href="eventosPublicxs1" role="button">Regresar</a>
