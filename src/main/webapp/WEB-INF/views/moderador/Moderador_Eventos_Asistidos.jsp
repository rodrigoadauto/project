    ...
    <div class="row flex-xl-nowrap">
      ...
      <div class="col-lg-3 ">
        ...
        <div class="list-group text-green">
          ...
          <a href="eventosAsistidos1" class="list-group-item  active">Eventos Asistidos</a>
...
<div class="card">
  <div class="card-header ">
    ...
    <li class="nav-item">
    <a class="nav-link active" href="eventosAsistidos1">Eventos Por Asistir</a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="eventosPorAsistir1">Eventos Asistidos</a>
    </li>
    </ul>
  </div>
  ...
  <div class="card-body">
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex ">
                                <a href="detalles31" ><h3 class="text-left" > <font color="black"> Teatro PUCP</font>  </h3> </a>
         ...
         <div class="d-flex ">
                                 ...
                                 <a class="btn btn-primary btn-lg mr-auto float-left" href="#" role="button">Reportar</a>
 
                                  <a class="btn btn-danger btn-lg float-right" href="#" role="button">No Asistir</a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex">
                                 <a href="detalles31" ><h3 class="text-left" > <font color="black"> Baila Por Tu Salud</font></h3></a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
              ...
              <div class="d-flex">
                                <a href="detalles31" ><h3 class="text-left" > <font color="black"> Coloquio De Física</font></h3></a>
