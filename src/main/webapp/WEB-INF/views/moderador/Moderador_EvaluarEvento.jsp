    ...
    <div class="row flex-xl-nowrap">
      ...
      <div class="col-lg-3 ">
        ...
        <div class="list-group text-green">
          ...
          <a href="evaluar" class="list-group-item active">Evaluar Eventos</a>
  ...
  <div class="card-body">
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex">
                                <a href="detalles111" ><h3 class="text-left" > <font color="black"> Teatro PUCP</font>  </h3> </a>
         ...
         <div >
                                  ...
                                  <a class="btn btn-danger btn-lg float-right " href="eventosPublicxs1" role="button">Eliminar</a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex">
                                <a href="detalles111" ><h3 class="text-left" > <font color="black"> Baila Por Tu Salud</font></h3></a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
              ...
              <div class="d-flex">
                                <a href="detalles111" ><h3 class="text-left" > <font color="black"> Coloquio Física</font></h3></a>
