                                        ...
                                        <div class="card mt-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div >
                                                    ...
                                                    <a class="btn btn-primary btn-lg float-left " href="${rootUrl}usuario/detallesMisEventos1/${listaMisEventos.id}" role="button"> Ver Detalles </a>
                                                    <a class="btn btn-danger btn-lg float-right " href="${rootUrl}usuario/eliminarEvento2/${listaMisEventos.id}" role="button"> Eliminar   </a>
