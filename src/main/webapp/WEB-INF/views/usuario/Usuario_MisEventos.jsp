...
<div class="card">
  <div class="card-header "> 
    <ul class="nav nav-tabs card-header-tabs">
        <li class="nav-item">
        <a class="nav-link active" href="misEventos"> Mis Eventos Por Ocurrir </a>
        </li>
        <li class="nav-item">
        <a class="nav-link" href="misEventosOcurridos"> Mis Eventos Ocurridos</a>
        </li>
        </ul>
   </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex ">
                                <a href="detalles2" ><h3 class="text-left" > <font color="black"> Teatro PUCP</font>  </h3> </a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex">
                                 <a href="detalles2" ><h3 class="text-left" > <font color="black"> Baila Por Tu Salud</font></h3></a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
              ...
              <div class="d-flex">
                                <a href="detalles2" ><h3 class="text-left" > <font color="black"> Coloquio De Física</font></h3></a>
