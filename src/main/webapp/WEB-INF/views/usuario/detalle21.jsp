                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div >
                                            ...
                                            <a class="btn btn-danger btn-lg float-right " href="${rootUrl}usuario/eliminarEvento2/${evento.id}" role="button">Eliminar</a>
                                            <a class="btn btn-primary btn-lg float-left " href="${rootUrl}usuario/misEventosOcurridos/${sessionScope.usuario.id}" role="button">Regresar</a>
