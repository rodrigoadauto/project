                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <c:forEach items="${listaEvento2}" var= "listaEvento">
                                    <div class="col-lg-4"> 
                            ...
                            <div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <c:forEach var="i" begin="1" end="${cantDePaginas2}" varStatus="loop">
                                            ...
                                            <c:if test="${paginaActual == i}">
                                                ...
                                                <c:if test="${paginaActual != i}">
                                                <li class="page-item active"><a class="page-link" href="${rootUrl}usuario/filtroTiempo?inicio=${i}&tiempo=${tiempo}">${i}</a></li>                                                
                                                </c:if>
