                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div >
                                            ...
                                            <a class="btn btn-danger btn-lg float-right " href="${rootUrl}usuario/eventosAsistidos/${sessionScope.usuario.id}" role="button"> Regresar </a>
                                            <a class="btn btn-danger btn-lg float-right " href="${rootUrl}usuario/noAsistir/${sessionScope.usuario.id}/${evento.id}" role="button">No Asistir</a>
