  ...
  <div class="card-body">
      ...
      <h5> Descripción: </h5>
         ...
         <div >
                                  ...
                                  <a class="btn btn-danger btn-lg float-right " href="eventosAsistidos" role="button">No Asistir</a>                                 
                  <a class="btn btn-primary btn-lg float-left " href="eventosAsistidos" role="button">Regresar</a>

                  <a class="btn btn-warning btn-lg float-left " href="eventosAsistidos" role="button">Reportar</a>
