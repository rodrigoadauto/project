  ...
  <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="23:00">
               ...
               <div class="d-flex ">
                <a class="btn btn-secondary btn-lg mr-auto float-left" href="misEventos" role="button">Regresar</a> 
                <a class="btn btn-secondary btn-lg float-right" href="misEventos" role="button">Actualizar Evento</a> 
