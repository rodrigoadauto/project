...
<body class="color" >
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="Usuario_Eventos_Publicos.jsp">EVENT PUCP</a>
...
<div class="card">
  <div class="card-header ">
    ...
    <li class="nav-item">
    <a class="nav-link active" href="eventosAsistidos">Eventos Por Asistir</a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="eventosPorAsistir">Eventos Asistidos</a>
    </li>
    </ul>
  </div>
  ...
  <div class="card-body">
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex ">
                                <a href="detalles3" ><h3 class="text-left" > <font color="black"> Teatro PUCP</font>  </h3> </a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
                            ...
                            <div class="d-flex">
                                 <a href="detalles3" ><h3 class="text-left" > <font color="black"> Baila Por Tu Salud</font></h3></a>
      ...
      <div class="col-lg-6"> 
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
              ...
              <div class="d-flex">
                                <a href="detalles3" ><h3 class="text-left" > <font color="black"> Coloquio De Física</font></h3></a>
